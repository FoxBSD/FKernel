...
>[!TIP]
> If you stay using a shell to write some script from FKernel and want show a error / warning message use "\033[41;37m **{Your Message Here}** \033[0m"

>[!TIP]
> If you stay using a shell to write some script from FKernel and want show a Information / Sucess Message use "\033[42;37mS  **{Your Message Here}** \033[0m"
